        ...
        ?>
                <figure class="alith_post_thumb">
                    <a href='/singleid=<?php echo $row['id']; ?>'>
                        <img class="w-100 h-10" src="<?= NEWS_UPLOAD_URL . $row['img_url']; ?>" alt="Banner Image">
                    </a>
                </figure>
                <!-- Edit -->
                <div id="bannerAdImageUpload">
                        <button type="button" class="addImgBtn" onclick="editImage(<?= $row['id']; ?>)">
                            <i class="fa fa-edit"></i>
                        </button>
                    <input type="file" name="bannerAdImg" class="addImgInput" onchange="handleBannerAdImg(event)" />
                </div>
                <!-- Delete -->
                <div id="bannerAdImagedelete">
                    <button type="button" class="deleteImgBtn" onclick="deleteImage(<?= $row['id']; ?>)">
...
<script>
    function editImage(imageId) {
        ...
        window.location.href = '<?= SITE_URL ?>banneradedit?id=' + imageId;
    }
</script>
...
<script>
    function deleteImage(imageId) {
        ...
        window.location.href = '<?= SITE_URL ?>banneraddelete?id=' + imageId;
    }
</script>
