					...
					<div class="owl-carousel owl-theme js section_margin line_hoz animate-box"
						...
						<div class="item">
							<figure class="alith_post_thumb_big">
								<span class="post_meta_categories_label">home_page 62 line, Blog</span>
								<div class="home_page_image_size">
									<img src="<?=BASE_URL?>web/images/slideshow.jpg" alt=""/>
								</div>
							</figure>
						...
						<div class="item"> 
							<figure class="alith_post_thumb_big">
								<span class="post_meta_categories_label">home_page 89 Fashion, Men</span>
								<div class="home_page_image_size">
									<img src="<?=BASE_URL?>web/images/slideshow.jpg" alt="" />
								</div>
							</figure>
						...
						<div class="item">
							<figure class="alith_post_thumb_big">
								<span class="post_meta_categories_label">home_page 119 Entertainment, Style</span>
								<div class="home_page_image_size">
									<img src="https://cdn.pixabay.com/photo/2024/02/27/00/13/heliconia-8599119_1280.jpg" alt="natureimg1" />
								</div>
							</figure>
							<h3 class="alith_post_title animate-box" data-animate-effect="fadeInUp">
								<a href='/single'>Lorem ipsum dui sollic itudin praesent ut mollis primis
